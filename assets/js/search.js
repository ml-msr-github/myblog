...
var documents = [{
    "id": 0,
    "url": "https://KeremTurgutlu.github.io/404.html",
    "title": "",
    "body": " 404 Page not found :(  The requested page could not be found. "
    }, {
    "id": 1,
    "url": "https://KeremTurgutlu.github.io/about/",
    "title": "About Me",
    ...
    "id": 2,
    "url": "https://KeremTurgutlu.github.io/categories/",
    "title": "Tags",
    "body": "Contents: {% if site. categories. size &gt; 0 %} {% for category in site. categories %} {% capture category_name %}{{ category | first }}{% endcapture %} {{ category_name }}{% endfor %}{% endif %} {% for category in site. categories %}  {% capture category_name %}{{ category | first }}{% endcapture %} &lt;h3 id = {{ category_name }} &gt;&lt;i class= fas fa-tags category-tags-icon &gt;&lt;/i&gt;&lt;/i&gt; {{ category_name }}&lt;/h3&gt;&lt;a name= {{ category_name | slugize }} &gt;&lt;/a&gt;{% for post in site. categories[category_name] %}{%- assign date_format = site. minima. date_format | default:  %b %-d, %Y  -%}&lt;article class= archive-item &gt; &lt;p class= post-meta post-meta-title &gt;&lt;a class= page-meta  href= {{ site. baseurl }}{{ post. url }} &gt;{{post. title}}&lt;/a&gt; • {{ post. date | date: date_format }}&lt;/p&gt;&lt;/article&gt;{% endfor %} {% endfor %}"
    }, {
    "id": 3,
    "url": "https://KeremTurgutlu.github.io/images/copied_from_nb/",
    "title": "",
    "body": "WarningDo not manually save images into this folder. This is used by GitHub Actions to automatically copy images.  Any images you save into this folder could be deleted at build time. "
    }, {
    "id": 4,
    "url": "https://KeremTurgutlu.github.io/intro/2020/02/23/introduction.html",
    "title": "PixelShuffle: Yet Another Machine Learning Blog",
    "body": "2020/02/23 -           What is PixelShuffle?&#182;: PixelShuffle is the name of this blog and also a very efficient upsampling layer in a CNN. For more check out the pixel shuffle paper. Since my research and experience focuses mostly on computer vision I thought it would cool to name it like this. Besides, I wasn't too picky about it 😊 Here is a youtube video where Jeremy explains what PixelShuffle layer is: Why not post on Medium?&#182;a) It's not free&#182;: I started blogging on Medium because it was a very fast and easy way to create and share content. Unfortunately, recently I started getting annoying blocker messages from Medium telling me to pay if I want to continue reading blog posts.  Eventhough, you can quickly work around this annoying message by disabling cookies through using your browser's incognito mode it's still a matter of taking a stand. I believe in open source philosophy, free education and equal rights for access to information. This is why I am putting all my blog posts down on Medium and migrating them to here.  b) fastpages is way cooler&#182;: Also by using fastpages we will have the full power of notebooks to create very cool blog posts!              #collapseprint(&quot;Welcome to my blog!&quot;)     Welcome to my blog!  "
    }, {
    "id": 5,
    "url": "https://KeremTurgutlu.github.io/fastpages/jupyter/2020/02/20/test.html",
    ...
    "id": 6,
    "url": "https://KeremTurgutlu.github.io/fastpages/markdown/2020/01/14/test-markdown-post.html",
